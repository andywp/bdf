                ...
                <td class="drow" valign="top" align="center" style="background-color: #ffffff; box-sizing: border-box; font-size: 0px; text-align: center;">
                  ...
                  <div class="layer_2" style="display: inline-block; vertical-align: top; width: 100%; max-width: 600px;">
                    <table border="0" cellspacing="0" cellpadding="0" class="edcontent" style="border-collapse: collapse;width:100%">
                      <tbody>
                        <tr>
                          <td valign="top" class="edimg" style="text-align: center; padding: 20px; box-sizing: border-box;"><img src="{{ asset('bdf/assets/images/logo-bdf.png') }}" alt="Image" style="border-width: 0px; border-style: none; max-width: 33px; width: 100%;" width="33"></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                ...
                <td class="drow" valign="top" align="center" style="background-color: #ffffff; box-sizing: border-box; font-size: 0px; text-align: center;">
                  ...
                  <div class="layer_2" style="max-width: 600px; display: inline-block; vertical-align: top; width: 100%;">
                    <table border="0" cellspacing="0" class="edcontent" style="border-collapse: collapse;width:100%">
                      <tbody>
                        <tr>
                          <td valign="top" class="edtext" style="padding: 20px; text-align: justify; color: #5f5f5f; font-size: 12px; font-family: &quot;Open Sans&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; word-break: break-word; direction: ltr; box-sizing: border-box;">
                            <p style="margin: 0px; padding: 0px;">Thank you for contacting us. We have entered your data into the database.</p>
                            <p style="margin: 0px; padding: 0px;">We will reply to any questions or information needed on this website.</p>
                            <p style="margin: 0px; padding: 0px;">We will notify you via email..</p>
                            <p style="margin: 0px; padding: 0px;"><br></p>
                            <p style="margin: 0px; padding: 0px;">Here are your data</p>
                            <p style="margin: 0px; padding: 0px;"><br></p>
                            <p style="margin: 0px; padding: 0px;">First Name : {{ $data->first_name }}</p>
                            <p style="margin: 0px; padding: 0px;">Last Name : {{ $data->last_name }}</p>
                            <p style="margin: 0px; padding: 0px;">Phone: {{ $data->phone }}</p>
                            <p style="margin: 0px; padding: 0px;">Email: {{ $data->email }}</p>
                            <p style="margin: 0px; padding: 0px;">Subject: {{ $data->subject }}</p>
                            <p style="margin: 0px; padding: 0px;">Message: {{ $data->message }}</p>
