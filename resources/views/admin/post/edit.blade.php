...
@section('content')
    ...
    <div class="row ">
        <div class="col-md-12" >
            <h4 class="card-title mb-3" >Edit BDF</h4>
            @if ($errors->any())
            ...
            @endif
            <form action="{{ route('admin.bdf.update',$data->id) }}" class="needs-validation" method="POST" novalidate enctype="multipart/form-data">
                <div class="row mb-3">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor" class="form-control  form-control-sm @error('post_content') is-invalid @enderror" name="post_content" required> {!! $data->post_content !!}</textarea>
                                    @error('post_content')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea rows="4" name="post_description" class="form-control form-control-sm @error('post_description') is-invalid @enderror" id="exampleInputUsername">{{ $data->post_description }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="post_tag" class="form-control form-control-sm @error('post_tag') is-invalid @enderror" id="validationTooltip03" value="{{ $data->post_tag }}">
                                    @error('post_tag')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card h-auto">
                            ...
                            <div class="card-body">
                                ...
                                <div class="upload-file">
                                    <div class="preview">
                                        <div><img  id="preview_add_post_image" src="{{ !empty($data->post_image)?asset('images/post/thumb/small/'.$data->post_image):asset('assets/images/default.jpg') }}"></div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row ">
                                    ...
                                    <div class="col-6 flot-end">
                                        ...
                                        <input type="checkbox" name="publish" value="1" {{ ($data->publish == '1' )?'checked':''; }}   data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-size="md" data-width="100">
                                    </div>
                            </div>
                        </div>
                ...
                <div class="pt-2 d-flex">
                    ...
                    <a  href="{{ route('admin.bdf.index') }}" class="btn btn-outline-danger " >Back</a>
                </div>
