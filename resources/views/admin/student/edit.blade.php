    ...
    <div class="row">
        <div class="col-md-12" >
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.student.update',$data->id) }}" class="needs-validation" method="POST" novalidate>
                        <div class="mb-3 row">
                        ...
                        <div class="pt-3">
                            ...
                            <a  href="{{ route('admin.student.index') }}" class="btn btn-outline-danger  mb-2 w-100" >Beck</a>
                        </div>
                    </form>
                </div>
            </div>
