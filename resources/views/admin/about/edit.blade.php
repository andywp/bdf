...
@section('content')
    ...
    <div class="row ">
        <div class="col-md-12" >
            <h4 class="card-title mb-3" >Edit About</h4>
            @if ($errors->any())
            ...
            @endif
            <form action="{{ route('admin.about.update',$data->id) }}" class="needs-validation" method="POST" novalidate enctype="multipart/form-data">
                <div class="row mb-3">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                ...
                <div class="pt-2 d-flex">
                    ...
                    <a  href="{{ route('admin.about.index') }}" class="btn btn-outline-danger " >Back</a>
                </div>
