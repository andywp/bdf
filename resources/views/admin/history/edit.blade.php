...
@section('content')
    ...
    <div class="row ">
        <div class="col-md-12" >
            <h4 class="card-title mb-3" >Edit History</h4>
            @if ($errors->any())
            ...
            @endif
            <form action="{{ route('admin.history.update',$data->id) }}" class="needs-validation" method="POST" novalidate enctype="multipart/form-data">
                <div class="row mb-3">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
